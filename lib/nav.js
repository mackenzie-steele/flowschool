...
(function () {
  ...
  var NAV = [
    ...
    { id: 'your-flows',           href: 'your-flows.html',                    icon: 'airline_stops',   label: 'Your Flows',           group: 'Create' },
    ...
    { id: 'pose-library',         href: 'pose-library.html',                 icon: 'book',            label: 'Pose Library',         group: 'Plan' },
    ...
    { id: 'teaching-log',         href: 'teaching-log.html',                  icon: 'history_edu',     label: 'Teaching Log',         group: 'Refine' },
  ];
  ...
  var FOOTER_TEXT = 'Flow School \u00B7 Tools for Yoga Teachers \u00B7 v1.14.10';
