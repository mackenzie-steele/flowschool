...
(function () {
  ...
  // ── Main landmark prep ────────────────────────────────────────────────────
  // The page footer is gone (2026-08: it dated every page and repeated what
  // the sidebar plate already says). This kept job is the skip link's
  // landing spot — remove it and "Skip to content" lands nowhere.
  ...
  function init() {
    ...
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', function () { prepMain(); watchSearch(); });
    } else {
      prepMain();
      watchSearch();
    }
